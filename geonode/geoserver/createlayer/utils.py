...
def get_attributes(geometry_type, json_attrs=None, is_slug=True):
    ...
    lattrs.append(gattr)
    lattrs.append(['created_by', f'java.lang.String', {'nillable': True}])
    lattrs.append(['created_at', f'java.lang.String', {'nillable': True}])
    lattrs.append(['updated_by', f'java.lang.String', {'nillable': True}])
    lattrs.append(['updated_at', f'java.lang.String', {'nillable': True}])
